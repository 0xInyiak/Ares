...
This version of Ares has been modified to run on HTTPS protocol
...
The server should now be accessible on https://localhost:8080
...
```
python3 builder.py -p Linux --server https://localhost:8080 -o agent
python3 agent
``` 
